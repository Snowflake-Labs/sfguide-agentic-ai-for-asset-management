...
def create_pdf_report_tool(session: Session):
    ...
    - Embedded SVG logo for Snowcrest Asset Management
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        <div class="header">
            <div class="header-logo">
                <img src="{{logo_src}}" alt="Snowcrest Asset Management" style="height: 50px;"/>
            </div>
            <div class="header-text">
                <h1 class="header-title" style="border: none; padding: 0;">SNOWCREST ASSET MANAGEMENT</h1>
        ...
        if document_audience == 'internal':
            ...
            <p><strong>Compliance Contact:</strong> compliance@snowcrest-am.demo</p>
            <p><strong>Generated:</strong> {{report_timestamp}}</p>
            \"\"\"
        else:  # external_client
            footer_content = f\"\"\"
            ...
            <p><strong>Contact:</strong> clientservices@snowcrest-am.demo</p>
            <p><strong>Generated:</strong> {{report_timestamp}}</p>
            \"\"\"
        ...
        <div class="demo-disclaimer">
            ...
            or genuine recommendations. Snowcrest Asset Management is a fictional entity created for this demo.
        </div>
        \"\"\"
        ...
        <head>
            <meta charset="UTF-8">
            <title>Snowcrest Asset Management - {{report_title}}</title>
        ...
        return f"[{{audience_label}}: {{report_title}}]({{presigned_url}}) - Professional PDF generated successfully with Snowcrest branding."
$$;
    """
    try:
