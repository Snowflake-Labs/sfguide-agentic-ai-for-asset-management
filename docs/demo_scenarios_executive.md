...
- **PDF Generation**: Branded internal document with Snowcrest logo
...
- **PDF Generation**:
  - Professional branded PDF with Snowcrest logo
...
- `SAM_SEC_FINANCIALS_VIEW`: Competitor data from SEC filings (existing)
