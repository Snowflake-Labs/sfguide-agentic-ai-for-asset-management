...
- **Brand Excellence**: Simulated branding reinforces institutional quality
...
- **PDF Generation**: Branded PDF with Simulated logo and client-appropriate formatting
...
**Note on Value Proposition Content**: The `search_philosophy_docs` tool will return documents including "Simulated Asset Management — Brand Messaging Guidelines" which contains comprehensive value proposition content under the "Core Value Propositions" section, covering Innovation Leadership, ESG Excellence, and Performance Focus messaging.
