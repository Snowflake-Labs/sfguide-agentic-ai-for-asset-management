...
> **Skills**: `pdf-report-generation`, `audience-adaptive-narrative`  
...
**Persona**: Sarah, Middle Office Operations Manager at Simulated Asset Management  
...
- `search_internal_docs` (Cortex Search) - Get custodian notifications for pending corporate actions
