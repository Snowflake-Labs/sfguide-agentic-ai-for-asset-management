...
**Persona**: David, Senior Research Analyst at Snowcrest Asset Management  
...
- `search_earnings_transcripts` (Cortex Search) - Get management guidance and strategic commentary
...
- `search_earnings_transcripts` (Cortex Search) - Get management commentary on risks
...
**Tools Used**:
- Synthesis of previous analysis (no additional tool calls needed)
...
- Complete research workflow in single session
...
**Technical Differentiators**:
- **Multi-Tool Orchestration**: Automatic coordination of Cortex Analyst and Cortex Search for comprehensive analysis
- **Structured Output Generation**: Professional investment memo format with executive summary
