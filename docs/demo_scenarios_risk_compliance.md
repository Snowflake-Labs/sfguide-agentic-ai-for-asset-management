...
**Persona**: Sofia, ESG & Risk Officer at Simulated Asset Management  
...
**User Input**: 
```
Scan for any new ESG controversies affecting our portfolio companies in recent NGO reports.
```
...
**Persona**: Michael, Compliance Officer at Simulated Asset Management  
...
### ESG Guardian - Complete ESG Assessment (Catch-All)
...
**Expected Response**:
- **Controversy Scan**: High and Medium severity issues from NGO reports
- **Exposure Analysis**: Portfolio weight and market value for flagged companies
- **Policy Verification**: ESG grade requirements and controversy tolerance thresholds
- **Engagement Status**: Previous discussions and company commitments
- **Remediation Plan**: Severity-based actions with timelines
- **Committee Report**: Formal ESG risk report for governance review

**Talking Points**:
- **Autonomous Orchestration**: AI independently selects and sequences all four ESG tools
- **Single-Query Capability**: Complete ESG assessment from one comprehensive question
- **Committee Ready**: Output structured for ESG Committee governance review
...
**Business Impact Summary**:
- **Rapid Response**: Complete ESG assessment available in under 5 minutes
- **Stakeholder Ready**: Output suitable for CEO briefing or stakeholder preparation
- **Comprehensive Coverage**: Combines controversies, exposure, policy, and engagement

**Technical Differentiators**:
- **Four-Tool Integration**: Demonstrates full ESG Guardian capability in single query
...
### Compliance Advisor - Complete Compliance Review (Catch-All)

#### Business Context Setup

**Persona**: Michael, Compliance Officer at Simulated Asset Management  
**Business Challenge**: Compliance officers sometimes need a complete compliance assessment with a single request when preparing for urgent regulatory inquiries or audit requests—requiring the AI to autonomously orchestrate all compliance tools.  
**Value Proposition**: The Compliance Advisor demonstrates complete autonomous orchestration by selecting and sequencing all tools from a single comprehensive question, delivering an audit-ready compliance report without step-by-step guidance.

**Agent**: `compliance_advisor`  
**Data Available**: Portfolio holdings across 10 strategies, policy documents, engagement records

#### Demo Flow

**Scene Setting**: Michael receives an urgent request from the FCA for a compliance status report on SAM Technology & Infrastructure. He has 30 minutes to prepare a complete assessment.

##### Step 1: Complete Compliance Assessment (All Tools)

**User Input**: 
```
Conduct a complete compliance assessment for SAM Technology & Infrastructure including all concentration limit checks against our Concentration Risk Policy thresholds, any engagement history documenting previous breach discussions with portfolio management, policy requirements for remediation timelines, and a formal compliance report with severity classification and recommended actions for the Risk Committee.
```

**Tools Used**:
- `quantitative_analyzer` (Cortex Analyst) - Check portfolio holdings against concentration limits
- `search_policies` (Cortex Search) - Retrieve Concentration Risk Policy thresholds
- `search_engagement_notes` (Cortex Search) - Review previous breach discussions

**Expected Response**:
- **Policy Thresholds**: Warning (6.5%) and breach (7.0%) limits from policy
- **Concentration Analysis**: All positions checked against limits with exact percentages
- **Breach Identification**: Positions exceeding thresholds with severity classification
- **Engagement History**: Previous discussions and PM commitments on breaches
- **Remediation Requirements**: Policy-mandated timelines and actions
- **Formal Report**: Audit-ready compliance report for Risk Committee

**Talking Points**:
- **Autonomous Orchestration**: AI independently selects and sequences all compliance tools
- **Single-Query Capability**: Complete compliance assessment from one comprehensive question
- **Audit Ready**: Output structured for regulatory submission

**Key Features Highlighted**: 
- **Multi-Tool AI Orchestration**: Agent autonomously determines tool sequence and synthesis
- **Policy + Holdings Integration**: Thresholds merged with position data for breach detection
- **Engagement Context**: Includes historical discussions for complete compliance picture

#### Scenario Wrap-up

**Business Impact Summary**:
- **Rapid Response**: Complete compliance assessment available in under 5 minutes
- **Regulatory Ready**: Output suitable for FCA or auditor submission
- **Comprehensive Coverage**: Combines policy, holdings, and engagement in single report

**Technical Differentiators**:
- **Three-Tool Integration**: Demonstrates full Compliance Advisor capability in single query
- **Policy-Aware Analysis**: AI applies exact policy thresholds to holdings data
- **Autonomous Operation**: True AI agent capability for compliance management
