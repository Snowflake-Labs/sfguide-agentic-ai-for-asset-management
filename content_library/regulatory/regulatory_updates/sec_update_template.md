---
doc_type: regulatory_updates
linkage_level: global
variant_id: sec_update_01
...
### 1. Enhanced Form ADV Part 2 Disclosures

**Fee Disclosures** (Item 5 amendments):
- More detailed breakdowns of all fee types and calculation methodologies
- Explicit disclosure of performance-based fee arrangements and potential conflicts
- Examples showing impact of fees on hypothetical $10,000 investment over various timeframes
- Clear explanation of fee-billing practices and client deduction authorization

**Conflict of Interest Disclosures** (Items 10-12 enhancements):
- Expanded disclosure of material conflicts including soft dollar arrangements
- More detailed explanation of proprietary product usage and affiliated party compensation
- Principal trading and agency cross transaction disclosures enhanced
- Third-party compensation arrangements requiring detailed disclosure

**Disciplinary History** (Item 9 clarifications):
- Broader scope of reportable events including settled matters without admission
- Enhanced disclosure of disciplinary events involving supervised persons
- Temporal expansion to include 10-year lookback period for certain violations
...
- Document cybersecurity governance and Board reporting

### 3. Quarterly Regulatory Asset Reporting

**Requirement** (Advisers managing >$1B):
- File regulatory asset under management calculations quarterly
- Provide detail on account types, fee structures, and asset categories
- Report advisory vs non-advisory assets separately
- Enhanced private fund reporting for advisers with fund clients
...
| Date | Milestone |
|------|-----------|
| 30 June 2024 | Internal gap analysis complete |
| 31 August 2024 | Form ADV Part 2 revisions drafted and reviewed |
| 1 September 2024 | Enhanced disclosures effective for new clients |
| 30 September 2024 | Technology system updates completed |
| 31 October 2024 | Existing client communications regarding enhanced disclosures |
...
- [ ] Complete comprehensive gap analysis against new requirements
- [ ] Engage legal counsel for Form ADV Part 2 revision support
- [ ] Assess technology system requirements for quarterly reporting
- [ ] Develop project plan with milestones and responsible parties

**Medium-Term** (30-90 Days):
- [ ] Draft revised Form ADV Part 2 brochure incorporating all new requirements
- [ ] Update client agreement templates
- [ ] Develop cybersecurity disclosure materials
- [ ] Configure quarterly regulatory asset reporting processes

**Pre-Deadline** (90-180 Days):
- [ ] File updated Form ADV Part 2 amendments
- [ ] Deliver enhanced disclosures to existing clients
...
- **Investment Team**: Cooperation with enhanced disclosure requirements
