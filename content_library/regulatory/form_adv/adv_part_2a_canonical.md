...
Additional information about Simulated Asset Management is available on the SEC's website at www.adviserinfo.sec.gov. You can search for our firm using our SEC file number 801-XXXXX or by our firm name.
...
Investment management services are highly customized to each client's specific circumstances, objectives, risk tolerance, and constraints. Clients may impose reasonable restrictions on investments including prohibited securities, sector limitations, or ESG criteria. All restrictions are documented in Investment Policy Statements and implemented through compliance controls.

### D. Wrap Fee Programs

Simulated Asset Management does not sponsor or participate in wrap fee programs.
...
**Investment Management Fees** (asset-based, annual rates):

| Assets Under Management | Annual Fee Rate |
|------------------------|----------------|
| First £5 million | 0.90% |
| Next £10 million | 0.65% |
...
Fees are calculated quarterly based on market value as of the last business day of each calendar quarter. Fees may be billed in advance or arrears as specified in client agreement.

Fees are typically deducted directly from client accounts with client authorization. Alternatively, clients may choose to receive invoices and remit payment separately.

Pro-rated fees apply for partial quarter periods based on account funding or termination dates.
...
Clients billed in advance receive pro-rated refund of unearned fees upon termination. Clients billed in arrears owe fees only for period services were provided. Either party may terminate advisory relationship upon 30 days written notice without penalty.

### E. External Compensation

Simulated Asset Management does not accept commissions, referral fees, 12b-1 fees, or other compensation from third parties for client investment recommendations. We are compensated solely by clients for investment advisory services, eliminating conflicts from external compensation.

---

## ITEM 6: PERFORMANCE-BASED FEES AND SIDE-BY-SIDE MANAGEMENT

Simulated Asset Management does not charge performance-based fees or incentive allocations. All fees are asset-based or fixed as described in Item 5. This eliminates conflicts between performance fee accounts and asset-based fee accounts.
...
Neither Simulated Asset Management nor its management persons have been involved in any legal or disciplinary events material to evaluation of our advisory business or the integrity of our management.
...
Neither the Firm nor our management persons are registered or have applications pending to register as broker-dealer or registered representative of broker-dealer.

### B. Futures/Commodities Registration

Neither the Firm nor our management persons are registered or have applications pending with the CFTC as futures commission merchant, commodity pool operator, commodity trading adviser, or associated persons.

### C. Material Relationships

The Firm has no material relationships or arrangements with related persons including broker-dealers, investment companies, other investment advisers, financial planning firms, banking institutions, accounting firms, or law firms that create material conflicts of interest with clients.
...
We have adopted a Code of Ethics establishing our commitment to ethical conduct and fiduciary standards. The Code requires:
- Placing client interests first in all decisions
- Avoiding conflicts of interest or full disclosure when conflicts exist
- Maintaining confidentiality of client information
- Acting with honesty, integrity, and good faith
- Compliance with securities laws and regulations

A copy of our Code of Ethics is available to clients upon request.
...
Personal trading creates potential conflicts:
...
We may receive research and brokerage services from broker-dealers that qualify as soft dollar benefits under Section 28(e) of the Securities Exchange Act. Services include:

- Third-party research reports and databases
- Market data and analytics platforms
- Portfolio management and trading systems

Soft dollar benefits create conflicts as we may have incentive to select broker-dealers based on research value rather than solely execution quality. We address this through:
- Evaluating execution quality independently of research services
- Documenting that research and brokerage services benefit clients
- Allocating soft dollar costs appropriately across client accounts

### C. Brokerage for Client Referrals

We do not consider client referrals from broker-dealers in selecting or recommending broker-dealers.

### D. Directed Brokerage

Clients may direct us to use specific broker-dealers. Directed brokerage may prevent us from achieving best execution and may result in higher commissions or less favorable prices. Directed brokerage accounts cannot participate in aggregated orders with other accounts.

### E. Order Aggregation

We aggregate (bunch) orders for multiple clients when possible to achieve better execution:
- **Benefits**: Potentially lower transaction costs and improved execution
- **Allocation**: Pro-rated based on order sizes
- **Partial Fills**: Allocated fairly across participating accounts
- **No Preferential Treatment**: No accounts receive systematically more favorable treatment
...
### A. Economic Benefits from Non-Clients

Our custodian relationships provide certain economic benefits including technology platforms, practice management support, and research access at no additional charge. These benefits create potential conflict as we may have incentive to recommend custodians providing greater benefits versus other factors. We address this by evaluating custodians based primarily on service quality, pricing, and client benefits rather than services provided to our firm.

### B. Compensation for Client Referrals

We do not compensate non-supervised persons for client referrals. We do not have solicitor arrangements or pay referral fees.

---

## ITEM 15: CUSTODY

Clients' funds and securities are held by qualified custodians: [List approved custodians]. Custodians send statements directly to clients at least quarterly showing all account activity, holdings, and values.

We have limited custody because we debit advisory fees directly from client accounts with client authorization. Custodian statements show fee deductions. Clients should verify fee calculations match agreed fee schedules.

Clients should carefully review custodian statements and compare with any reports we provide. Contact us promptly with any questions or discrepancies.
...
Discretionary authority is granted through Investment Management Agreement and documented in custodian account opening paperwork. Limitations are documented in Investment Policy Statements.
...
We will vote proxies on behalf of clients unless client retains voting authority. Our Proxy Voting Policies are available upon request and summarize our approach to proxy voting.

### B. Proxy Voting Procedures

We vote proxies in clients' best interest considering proposal's impact on shareholder value. Key considerations:
- Director elections: Independence, qualifications, diversity
- Executive compensation: Alignment with performance and shareholder interests
- Corporate governance proposals: Board structure, shareholder rights
- ESG proposals: Material sustainability matters and disclosure enhancement

Conflicts of interest in proxy voting are resolved by independent third-party recommendations or client consultation.
...
We do not provide advice or take action regarding class action participation. Clients receive notices directly from custodians and may pursue participation independently.
...
We are not required to provide balance sheet because we do not require or solicit prepayment of fees six or more months in advance.

### B. Financial Condition

We are not aware of any financial condition reasonably likely to impair our ability to meet contractual commitments to clients. The Firm maintains adequate capital, liquidity, and professional indemnity insurance to support ongoing operations and client service.

### C. Bankruptcy

Simulated Asset Management has not been the subject of bankruptcy petition at any time.
...
We maintain strict privacy and confidentiality protections for client information. Our Privacy Policy, delivered annually, describes information collection, usage, sharing, and security practices. We do not sell client information to third parties.

### Business Continuity

We maintain comprehensive business continuity plan enabling continued client service during disruptions. Plan includes backup systems, remote work capabilities, and alternative site operations. Plan tested annually.

### Cybersecurity

Client information protected through encryption, multi-factor authentication, network security, and regular security assessments. We maintain cyber liability insurance and incident response protocols.

---

## BROCHURE SUPPLEMENTS

Please see attached Brochure Supplements (Form ADV Part 2B) providing biographical information for portfolio managers and senior investment professionals.

---

This brochure accurately describes Simulated Asset Management's advisory business as of the date noted. Material changes will be disclosed through updated brochures or supplements delivered to clients within 30 days.
...
*SEC Form ADV Part 2A — Simulated Asset Management*
