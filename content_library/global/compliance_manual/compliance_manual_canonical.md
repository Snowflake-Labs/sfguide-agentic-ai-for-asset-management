...
# Simulated Asset Management — Compliance Manual
...
2. Code of Ethics and Standards of Business Conduct
3. Personal Securities Trading
4. Portfolio Management and Trading
5. ESG Compliance and Monitoring
6. Fixed Income Compliance Standards
...
This Compliance Manual establishes policies, procedures, and standards governing Simulated Asset Management's ("SAM" or "the Firm") investment advisory operations. The Manual implements our commitment to regulatory compliance, ethical conduct, and fiduciary excellence in serving client interests.

All employees, officers, and supervised persons ("Covered Persons") must comply with this Manual's requirements. Violations may result in disciplinary action up to and including termination of employment.

### Regulatory Framework

SAM is registered with the U.S. Securities and Exchange Commission ("SEC") as an investment adviser under the Investment Advisers Act of 1940. We are also subject to regulations in jurisdictions where we operate or serve clients including UK Financial Conduct Authority (FCA) rules where applicable.
...
SAM operates as fiduciary to clients. All Covered Persons must:
- Place client interests first in all investment decisions and recommendations
- Act with integrity, competence, diligence, respect, and ethical judgment
- Avoid conflicts of interest or disclose them fully when unavoidable
- Maintain strict confidentiality of client information
- Comply with all applicable laws, regulations, and Firm policies
...
Violations of personal trading policies result in disciplinary action:
- **Minor Violations** (inadvertent, no client harm): Written warning, retraining
- **Material Violations** (intentional, potential client harm): Suspension, disgorgement of profits, probation
- **Egregious Violations** (front-running, MNPI trading): Termination, regulatory referral
...
### ESG-Labelled Portfolio Requirements
...
- Monitoring: Monthly ESG rating checks with exception reporting

**Exclusions** (ESG-labelled portfolios):
- Controversial weapons manufacturers (0% tolerance)
- Tobacco production (0% tolerance)
- Thermal coal extraction >5% revenue (0% tolerance)
...
4. Disposition required within 90 days unless approval granted
5. Client notification if material ESG controversy affects holdings
...
**High-Quality Portfolios** (Conservative strategies):
...
- Execute reduction within 30 business days
...
- Market impact considerations allow phased reduction
...
- Marketing materials review (new materials)
...
- Brokerage relationships and soft dollars
...
Violations investigated promptly and thoroughly. Appropriate disciplinary action determined by violation severity, intent, harm caused, and prior history. Disciplinary outcomes documented and reported to senior management and Board as appropriate.

---

## 12. POLICY REVIEW AND UPDATES

This Compliance Manual reviewed and updated at least annually. Ad hoc updates made for regulatory changes, operational modifications, or identified gaps. All Covered Persons notified of material policy changes and required to acknowledge receipt.
...
*Simulated Asset Management Compliance Manual — Version 3.0 — Internal Confidential*
