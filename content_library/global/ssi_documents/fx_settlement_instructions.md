...
## Overview
This document defines the standard settlement instructions for foreign exchange transactions executed for Simulated Asset Management portfolios. All FX settlements must adhere to these procedures.
