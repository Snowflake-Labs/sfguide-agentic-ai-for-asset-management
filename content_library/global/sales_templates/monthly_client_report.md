...
variant_id: monthly_report_template
...
This template provides standardised structure for monthly client portfolio reports. Sections should be populated with client-specific data, performance attribution, and market commentary whilst maintaining consistent formatting and professional presentation standards. All reports must include required regulatory disclosures and comply with brand guidelines.
...
|--------|------------------|------------------|-----------------|
| Month | [X.X%] | [X.X%] | [+/-X.X%] |
| Quarter-to-Date | [X.X%] | [X.X%] | [+/-X.X%] |
| Year-to-Date | [X.X%] | [X.X%] | [+/-X.X%] |
| 1 Year | [X.X%] | [X.X%] | [+/-X.X%] |
| 3 Year (Annualised) | [X.X%] | [X.X%] | [+/-X.X%] |
...
|-------------|-----------|----------|-----------|-----------|
| Equities | [XX%] | [XX%] | [XX-XX%] | [+/-X%] |
| Fixed Income | [XX%] | [XX%] | [XX-XX%] | [+/-X%] |
| Alternatives | [XX%] | [XX%] | [XX-XX%] | [+/-X%] |
| Cash | [XX%] | [XX%] | [XX-XX%] | [+/-X%] |

**Sector Allocation** (Equities):
- Technology: [XX%] (Benchmark: [XX%])
- Healthcare: [XX%] (Benchmark: [XX%])
...
- Sustainability metrics if relevant to portfolio mandate
...
- Any anticipated portfolio changes or rebalancing needs
- Reinforcement of long-term strategy and discipline
...
*Monthly Client Report Template — Snowcrest Asset Management*  
