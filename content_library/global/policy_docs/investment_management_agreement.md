...
variant_id: ima_template
word_count_target: 1280
placeholders:
  required: []
---

# Investment Management Agreement — Key Terms Template
...
The Investment Manager shall manage the Portfolio in accordance with the investment objectives specified in the attached Investment Policy Statement, seeking to achieve:

- Long-term capital appreciation and/or income generation as specified
- Returns exceeding the performance of designated benchmarks
- Risk management consistent with stated risk tolerance and objectives
- Compliance with all investment guidelines and restrictions
...
Investment Manager shall maintain portfolio asset allocation within ranges specified in the Investment Policy Statement. Permitted asset classes include:
...
- Other securities as specifically approved
...
Portfolios without explicit ESG labels incorporate ESG factors into fundamental analysis:
- ESG considerations integrated into company research and investment decisions
- Material ESG risks identified and assessed
- No requirement for minimum ESG ratings unless specified
- Controversial weapons exclusions apply to all portfolios
...
- Options, futures, or derivatives (except for approved hedging purposes)
- Short selling or margin borrowing
...
Investment Manager conducts daily compliance monitoring including:
- Position concentration checks against 7.0% hard limit and 6.5% warning threshold
- Investment mandate adherence verification
- Quality standard compliance (Investment Grade percentages)
- Prohibited investment screening
- Cash level adequacy
...
- May temporarily exceed limit during reduction if immediate sale would create market impact concerns
...
- Fee summary and expense disclosure
...
- Extraordinary expenses with prior approval
...
*Snowcrest Asset Management | Investment Management Agreement Template | For Internal Use*
