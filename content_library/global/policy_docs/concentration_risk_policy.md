...
variant_id: concentration_risk_policy
...
### 3.2 Industry Group Limits

- **Maximum 15%** in any GICS Level 3 industry group
- **Early Warning**: 12% industry concentration triggers review
- **Monitoring**: Monthly industry composition analysis

---

## 4. Geographic Concentration Limits
...
- **Unhedged Currency Risk**: Maximum 20% of portfolio in unhedged foreign currency exposure
- **Single Currency**: Maximum 10% exposure to any non-base currency
- **Hedging Policy**: Material currency exposures >10% should be substantially hedged unless actively managed

---

## 5. Asset Class Concentration Limits
...
- **Maximum 10%** in illiquid securities (unable to liquidate within 5 business days at fair value)
- **Private Placements**: Maximum 5% in private placements or restricted securities
- **Review Process**: Quarterly liquidity assessment required
...
## 7. Breach Resolution Process

### 7.1 Immediate Actions (Breach >7.0%)
...
### 7.2 Warning Threshold Management (6.5-7.0%)
...
- **Annual Review**: Comprehensive policy assessment each January
- **Regulatory Updates**: Immediate updates for regulatory changes
- **Best Practice Evolution**: Ongoing monitoring of industry standards
- **Client Feedback**: Annual review of client concentration requirements

---

## 9. Related Policies and Procedures

- Investment Policy Statements (Portfolio-Specific)
- Investment Management Agreements
- Risk Management Framework
- Trading and Best Execution Policy
...
*This policy represents Snowcrest Asset Management's commitment to prudent concentration risk management. All personnel managing client assets must understand and adhere to these concentration limits.*
