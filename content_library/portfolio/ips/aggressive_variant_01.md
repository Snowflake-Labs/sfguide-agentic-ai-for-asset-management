...
This Investment Policy Statement establishes objectives, guidelines, and constraints for the {{PORTFOLIO_NAME}}, an aggressive growth-oriented investment strategy. The IPS provides governance framework for maximising long-term capital appreciation through concentrated exposure to high-growth equities and thematic investment opportunities.
...
|-------------|----------|-----------|-----------|-----------|
| **Equities** | **90%** | **80%** | **95%** | |
| - Growth Equities | 70% | 50% | 85% | Nasdaq 100 |
| - International Growth | 15% | 10% | 25% | MSCI ACWI ex-US Growth |
| - Small/Mid Cap Growth | 5% | 0% | 15% | Russell 2000 Growth |
| **Alternatives** | **5%** | **0%** | **10%** | |
| - Thematic ETFs | 5% | 0% | 10% | Various |
| **Cash** | **5%** | **0%** | **20%** | Cash |
| **TOTAL** | **100%** | | | |
...
- Top 10 holdings may represent 55-70% of portfolio (concentrated approach)
- Minimum position size 2% (avoid over-diversification)

**Quality Preferences** (Guidelines not Constraints):
- Companies with revenue growth >15% annually preferred
- Positive or path to positive free cash flow within 24 months
...
## 8. IPS Review and Updates

Annual formal review required. Amendments for material changes in objectives, risk tolerance, or market environment. Review triggered if sustained underperformance versus benchmark or objectives.

---

## Acknowledgement

The undersigned understand the aggressive growth mandate, associated risks, and performance expectations for the {{PORTFOLIO_NAME}}.
...
*Snowcrest Asset Management — Aggressive Growth Strategy IPS*
